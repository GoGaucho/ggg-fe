<template>
  <div class="events">
    <h1>Events</h1>
    <el-table :data="events" style="width: 100%;" empty-text="No Event">
      <el-table-column prop="name" label="Name" align="center" />
      <el-table-column prop="days" label="Days" align="center" />
      <el-table-column
        prop="timerange"
        label="Time Range"
        ...
        align="center"
      />
      <el-table-column prop="duration" label="Duration(min)" align="center" />
      <el-table-column fixed="right" label="Remove" width="100" align="center">
    ...
    <div class="row">
      ...
      <el-button
        plain
        :disabled="!(name && days.length && duration)"
        type="primary"
        style="margin-left: 30px;"
        @click="add"
      >Add to Events</el-button>
    </div>
    <div class="row">
      <strong>Days:</strong>
      <el-select
        ...
        @change="sortDays"
      >
        <el-option v-for="o in daysOptions" :value="o.key" :label="o.name" v-bind:key="o.key" />
      </el-select>
    </div>
    <div class="row">
